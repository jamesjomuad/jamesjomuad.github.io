...
//
	APP.service('Service', function($filter) {
		...
		var storage 	= localStorage.getItem('expenses') ? localStorage.getObject('expenses') : {};	// private variable
		var expenses 	= localStorage.getItem('expenses') ? localStorage.getObject('expenses') : {};	// private variable
		...
		this.income		= localStorage.getItem('income') ? localStorage.getItem('income') : 0;
		this.date		= {
		...
		this.save		= function(data){
			localStorage.setObject('expenses', _app.expenses);
			// localStorage.setItem('income',_app.income);
			console.log(_app);
			return "saved";
		};
